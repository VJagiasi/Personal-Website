...
const Footer = () => {
  return (
    <div className="bg-background h-auto text-xl font-rubik flex flex-col justify-start items-end px-8 text-text-color text-left ">
      <div className="max-w-4xl mx-auto mt-10">
          <h1 className="text-4xl mt-4 mb-6 text-white font-bold">Want to connect?</h1>
