...
const Footer = () => {
  return (
    <div id="contact"className="bg-background dark:bg-white h-auto text-xl font-rubik flex flex-col justify-start items-end px-8 text-text-color text-left ">
      <div className="max-w-4xl mx-auto dark:text-black mt-10">
          <h1 className="nav-link text-4xl mt-4 mb-6 text-white dark:text-black font-bold">Want to connect?</h1>
        ...
        <div className="flex flex-row-reverse justify-around items-center my-10">
          ...
          <div className="text-text-color dark:text-black my-6">
