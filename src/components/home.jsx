...
const Home = () => {
  return (
    <div className="bg-background h-auto p-10 text-2xl font-bold font-rubik flex flex-col justify-center items-start px-8 text-text-color text-left">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-text-color my-6">
              <a href="https://github.com/VJagiasi" target="_blank" className="mr-4"><FontAwesomeIcon icon={faGithub} size="2x"></FontAwesomeIcon></a>
              <a href="https://www.linkedin.com/in/vihaanjagiasi/" target="_blank" className="mr-4"><FontAwesomeIcon icon={faLinkedin} size="2x"></FontAwesomeIcon></a>
              <a href="mailto:vihaan@jagiasi.com" target="_blank" className="mr-4"><FontAwesomeIcon icon={faEnvelope} size="2x"></FontAwesomeIcon></a>
              <a href="https://twitter.com/VihaanJagiasi" target="_blank" className="mr-4"><FontAwesomeIcon icon={faTwitter} size="2x" href=""></FontAwesomeIcon></a>
          </div>
