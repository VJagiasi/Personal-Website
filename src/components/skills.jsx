  ...
  return (
    <div className="bg-background h-auto text-2xl font-bold font-rubik flex flex-col justify-center items-start px-8 text-text-color text-left">
      <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl mt-4 mb-6 text-white">Skills</h1>
          ...
          <div className="flex justify-center my-20">
            ...
            <div className="bg-background-icons text-xl text-white py-8 px-8  rounded-3xl b mx-6 flex flex-col justify-center items-center">
                <img src={react} alt="logo" width="50px"/>
                <p>React</p>
            </div>
            <div className="bg-background-icons text-xl text-white py-8 px-6 rounded-3xl b mx-6 flex flex-col justify-center items-center">
            ...
            <div className="bg-background-icons text-xl text-white py-8 px-5  rounded-3xl b mx-6 flex flex-col justify-center items-center">
